...
namespace x::va
{
	...
	private:
		...
		{
			x::va::expand((args_[i] = other.args_[i]->copy())...);
		}
	...
	struct expand
	{
		...
		__forceinline constexpr expand(_Type&&...) {}
	};

	/*template<class... _Type>
	__forceinline constexpr void x::va::expand(_Type...) {}*/
...
//#define x::va::expand(...) x::va::x::va::expand{__VA_ARGS__}
